...
function AddList({setList}) {
    ...
    return(
        <form className='addForm' onSubmit={handleSubmit}>
            <input type="text" name="PatName" placeholder="Enter User Name" ref={PatNameRef}/>
            <input type="text" name="Reason" placeholder="Appliance Name" ref={ReasonRef}/>
            <input type="text" name="AppDate" placeholder="Enter Rental_Date" ref={AppDateRef}/>
            <input type="text" name="AppTime" placeholder="Enter Rental_Time" ref={AppTimeRef}/>
